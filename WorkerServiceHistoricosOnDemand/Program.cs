...
try
{
    ...
    var logFilePath = Path.Combine(logDir, "WorkerServiceHistoricosOnDemand-.log");
    ...
    var host = Host.CreateDefaultBuilder(args)
        ...
        {
            options.ServiceName = "SOLTEC - Worker Service Históricos On Demand";
        })
        .UseSerilog()
        .ConfigureServices((context, services) =>
        {
            ...
            // Servicios internos
            services.AddScoped<HistoricosOnDemand>();
